                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _buildDrawerItem(context, icon: Icons.info_outline,
                          title: 'About Pubup', route: AppRoutes.aboutUsScreen),
...
import 'package:new_pubup_partner/data/source/local/global_data/profile_data.dart';
import 'package:new_pubup_partner/data/source/network/end_points.dart';
import 'package:new_pubup_partner/features/vendor_profile_screen/bloc/vendor_all_details_bloc.dart';
import 'package:new_pubup_partner/features/vendor_profile_screen/event/vendor_all_details_event.dart';
...
class _PremiumAnimatedDrawerState extends State<PremiumAnimatedDrawer> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider<VendorAllDetailsBloc>(
          create: (context) {
            final vendorId = BusinessProfileData.vendorId();
            return VendorAllDetailsBloc()..add(FetchVendorAllDetailsEvent(vendorId: vendorId ?? ''));
          },
        ),
      ],
                    ...
                    loadingBuilder: (context, child, loadingProgress) {
                      ...
                      return Center(
                        child: CircularProgressIndicator(
                          strokeWidth: 2,
                          valueColor: AlwaysStoppedAnimation<Color>(dynamicThemeColor(context)),
                        ),
                      );
                    },
                  ),
